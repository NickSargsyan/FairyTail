...
#import "FairyTailAppDelegate.h"
#import "FairyTailReaderViewController.h"

@implementation FairyTailAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    FairyTailReaderViewController *readerViewController = [[FairyTailReaderViewController alloc] init];
